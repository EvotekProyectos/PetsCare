...
function togglee(radio) {
  ...
  switch (type) {
    ...
    case 3:
      document.getElementById("mvz").style.display = "block";
      document.getElementById("veterinarian_id_mvz").style.display = "none";
      document.getElementById("veterinarian_id_colaborador").style.display =
        "block";
