...
<body>
            ...
            <table style="width: 100%;">
                <tr>
                    <th style="text-align: center; width: 20%">
                        <p style="font-size: 15pt; font-weight: bold;font-family:sans-serif;">PROTOCOLO DE RECEPCIÓN DE MASCOTA
                            EN GROOMING EN ESTADO CRÍTICO
                        </p>
                    </th>
                </tr>
            </table>
            ...
            <tr>
                <td style="text-align: justify; line-height: 1.5;">
                    ...
                    @if (!isset($isPdf) || !$isPdf)
                        <input type="text" id="name" value="{{ $name ?? '' }}" class="form-control" style="width: 700px;">
                    @else
                        <span>{{ $name ?? '' }}</span>
                    @endif
                    autorizo a Pets Care a que proceda a efectuar la rapa  baño de mi mascota estando consciente de que al efectuarse
                    este procedimiento mi mascota puede traer heridas, hongos, rapasduras, garrapatas, pulgas, ácaros e infecciones de piel etc. <br>
                    Ya que no ha sido sometido a una rutina de estética permanente, por tal motivo eximo de responsabilidad a dicha empresa.
                </td>
            </tr>
        </table>
    ...
    <div style="text-align: center;">
        <p style="margin-top: 80px;"><b>FIRMA:</b></p>
    ...
    <script src="{{ asset('js/groomings/critic-status.js') }}" defer></script>
    <script>
        const ID = "{{ $general->id }}";
    </script> 
