<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        {{-- FIX: "padding: 10px;" estaba pegado dentro de class="...", tratado como
             clases CSS inexistentes en vez de un estilo. Se separó a style="...". --}}
        ...
        <div class="row">
            ...
            {{-- FIX: faltaba este </div> para cerrar el <div class="row"> de
                 ALIMENTACIÓN. Sin él, todo lo que sigue (PENDIENTES, HERIDA,
                 etc.) quedaba anidado por error dentro de esta fila, y el
                 </div> final del archivo terminaba cerrando esta fila en vez
                 de los wrappers exteriores (ver el otro FIX al final). --}}
        </div>
        ...
        {{-- FIX: mismo problema de "padding: 10px;" pegado en class. --}}
        <div class="text-center bg-primary text-white py-1 mb-4" style="padding: 10px;">
    ...
    @endunless
    {{-- FIX: faltaba este </div> extra al final para cerrar correctamente
         <div class="col-md-12"> y <div class="row padding-1 p-1"> del inicio
         del archivo (antes solo había un </div> aquí, dejando ambos
         wrappers exteriores sin cerrar). --}}
    </div>
</div>