<div class="row padding-1 p-1">
    <div class="row">
        ...
        <div class="form-group mb-2 mb20" hidden>
            <label for="budget_id" class="form-label">{{ __('Budget Id') }}</label>
            <input type="text" name="budget_id" class="form-control @error('budget_id') is-invalid @enderror"
                value="{{ old('budget_id', $budget?->id) }}" id="budget_id" placeholder="Budget Id">
        ...
        <div class="col-5 form-group mb-2 mb20">
            <label for="service_id" class="form-label">SERVICIO/S MÉDICOS</label>
            <div class="input-group mb-3">
                ...
                <select name="service_id" class="form-control @error('service_id') is-invalid @enderror"
                    id="service_id" onchange="getprice(this.value)">
                    ...
                    @foreach ($products as $product)
                        ...
                        <option value="{{ $product->ARTICULO_ID }}" name="service_id"
                            {{ old('service_id', $budgetDetail?->service_id) == $product->ARTICULO_ID ? 'selected' : '' }}>
            ...
            <div class="form-group mb-2 mb20">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="price" class="form-control @error('price') is-invalid @enderror"
                        value="{{ old('price', $budgetDetail?->price) }}" id="price" placeholder="Precio">
                </div>
            ...
            <div class="form-group mb-2 mb20">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="notes" class="form-control @error('notes') is-invalid @enderror"
                        value="{{ old('notes', $budgetDetail?->notes) }}" id="notes" placeholder="Notas">
                </div>
