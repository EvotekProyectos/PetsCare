...
<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="row">
                ...
                <div class="form-group mb-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea name="observations" rows="4"
                            class="form-control @error('observations') is-invalid @enderror"placeholder="Nombre o texto de la placa y otras observaciones"
            ...
            <!-- Tipo de Placa con Radio Buttons -->
            <div class="col-md-6">
                <div class="form-group mb-2">
                    <label for="placa_type_id" class="form-label">TIPO DE PLACA</label>
                    <div class="d-flex gap-3 align-items-center" style="margin-right: 30px;">

                        <label class="text-center" style="margin-right: 10px;">

                            <img src="{{asset('img/bone.png')}}" alt="Placa Hueso" class="img-fluid mb-2" style="width: 60px; height: 60px; shadow-custom;">
                            <br>
                        ...
                        <label class="text-center">
                            <img src="{{asset('img/circle.png')}}" alt="Placa Circular" class="img-fluid mb-2" style="width: 60px; height: 60px;">
                            <br>
