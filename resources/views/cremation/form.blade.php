...
<div class="row padding-1 p-1">
    <div class="col-md-12">
                ...
                <div class="form-group mb-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="datetime-local" name="date_death"
                            ...
                            value="{{ old('date_death', $cremation?->date_death ? \Carbon\Carbon::parse($reception->entry_date)->format('Y-m-d\TH:i') : now()->format('Y-m-d\TH:i')) }}"
                            id="date_death" placeholder="Date Death">
                    </div>
                ...
                <div class="form-group mb-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="type_urn"
                            ...
                            value="{{ old('type_urn', $cremation?->type_urn) }}" id="type_urn"
                            placeholder="Tipo de urna">
                    </div>
            ...
            <div class="col-md-6">
                <div class="form-group mb-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea name="observations" rows="5" class="form-control @error('observations') is-invalid @enderror"
                            placeholder="" id="observations">{{ old('observations', $cremation?->observations) }}</textarea>
                    </div>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <div class="d-flex gap-3 align-items-center">
                                <label class="text-center" style="margin-right: 10px;">
                                    <img src="{{ asset('img/bone.png') }}" alt="Placa Hueso"
                                        class="img-fluid mb-2 shadow-custom"
                                        style="width: 80px; height: 80px; border-radius: 50%; box-shadow: 0 8px 15px rgba(0, 0, 0, 0.3);">
                                    <br>
                                    <input type="radio" name="placa_type_id" value="1"
                                        class="form-check-input">
                                </label>
                                <label class="text-center">
                                    <img src="{{ asset('img/circle.png') }}" alt="Placa Circular"
                                        class="img-fluid mb-2"
                                        style="width: 80px; height: 80px;border-radius: 50%; box-shadow: 0 8px 15px rgba(0, 0, 0, 0.3);">
                                    <br>
                                    <input type="radio" name="placa_type_id" value="2"
                                        class="form-check-input">
                                </label>
                            </div>
                            {!! $errors->first(
                    ...
                    <div style="flex: 1;">
                        <div class="form-group mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="text_placa" rows="5" class="form-control @error('text_placa') is-invalid @enderror"
                                    placeholder="Nombre o texto que se desea para la placa" id="text_placa">{{ old('text_placa', $cremation?->text_placa) }}</textarea>
                            </div>
        ...
        <div class="form-group mb-2 mb20" hidden>
            ...
            <input type="text" name="price" class="form-control @error('price') is-invalid @enderror"
                value="{{ old('price', $cremation?->price) }}" id="price" placeholder="Price">
    ...
    <div class="col-12 mt-2 d-flex justify-content-end">
        <button type="submit" class="btn btn-finalizar-consulta btn-sm text-uppercase rounded-4 px-3">
