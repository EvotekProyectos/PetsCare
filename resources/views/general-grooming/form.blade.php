                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="datetime-local" name="next_service"
                            ...
                            value="{{ old('next_service', $generalGrooming?->next_service) }}" id="next_service"
                ...
                <div class="form-group mb-2 mb20">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea name="delivery_references" class="form-control @error('delivery_references') is-invalid @enderror"
                            id="delivery_references" placeholder="Indique las referencias para el servicio a domicilio" rows="1">{{ old('delivery_references', $generalGrooming?->delivery_references) }}</textarea>
