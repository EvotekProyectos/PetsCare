                ...
                <div class="card bg-primary-soft border-0 p-3">
                    <div class="card-header bg-transparent border-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 id="card_title" class="text-primary text-uppercase">
                                <span class="icon-park-outline--hotel"></span> HOTEL
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="row card-body">
                        ...
                        <div class="row d-flex justify-content-center " style="margin-bottom: -11px;">
                            ...
                            <div class="col-md-3">
                                <p style="font-weight: bold">Entrada: <span style="font-weight: normal">
                        ...
                        <div class="row d-flex justify-content-center " style="margin-bottom: -11px;">
                            ...
                            <div class="col-md-3">
                                <p style="font-weight: bold">Salida estimada: <span style="font-weight: normal">
                        ...
                        <div class="row d-flex justify-content-center ">
                            ...
                            <div class="col-md-3">
                                <p style="font-weight: bold">No. Collar: <span style="font-weight: normal">
                        ...
                        <div class="row d-flex justify-content-around align-content-center mb-3">
                            <div class="col-12 col-lg-3 d-flex justify-content-between align-items-center my-2">
                                <div class="col">
                                    ...
                                    onclick="video('{{ $reception->family->phone ?? '' }}', '{{ $reception->id }}')">
                                        <span class="badge custom-badge-pill"><span
                                                class="ri--whatsapp-fill" style="font-size: 16px;"></span> </span> <small>
                                            ENVIAR VIDEO</small>
                                    </a>
                                </div>
                            </div>
                            <div class="col-12 col-lg-3 d-flex justify-content-between align-items-center my-2">
                                <div class="col">
                                    <a class="btn btn-costum-services btn-lg text-uppercase rounded-5 shadow w-100 fs-6 d-flex justify-content-around align-items-center "
                                        href="{{ route('pension.inf', $reception->id) }}"  target="_blank">
                                        <span class="badge custom-badge-pill"><span
                                                class="material-symbols--print" style="font-size: 20px;"></span> </span> <small>
                                           INFORMACIÓN SERVICIO </small></a>
                                </div>
                            ...
                            <div class="col-12 col-lg-3 d-flex justify-content-between align-items-center my-2">
                                <div class="col">
                                    <a class="btn btn-costum-services btn-lg text-uppercase rounded-5 shadow w-100 fs-6 d-flex justify-content-around align-items-center "
                                    onclick="AddExtension('{{ $reception->id }}')">
                                        <span class="badge custom-badge-pill"><span
                                                class="material-symbols--add-rounded" style="font-size: 20px;"></span> </span> <small>
                                          EXTENDER SERVICIO</small></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-12">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover responsive w-100" id="tableVideo">
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-between align-items-center">
                                <h5 id="card_title" class="text-primary text-uppercase">
                                    <span class="ic--twotone-pets"></span>SERVICIO
                                </h5>
                            </div>
                            <div class="col-12 col-lg-12">
                                <div class="table-responsive">
...
@push('scripts')
    ...
    <script src="{{ asset('js/hotels/show.js') }}" defer></script>

<script src="https://cdn.jsdelivr.net/npm/dayjs@1/dayjs.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/dayjs@1/locale/es.js"></script>
<script>
    dayjs.locale('es'); // Configurar en español
</script>
