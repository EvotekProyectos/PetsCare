...
<input type="hidden" id="cubicle_end_date" value="{{ $lastHotel?->cubicle?->end_date }}">
            ...
            <div class="col-12">
                ...
                <div class="card bg-primary-soft border-0 p-3">
                    <div class="card-header bg-transparent border-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 id="card_title" class="text-primary text-uppercase">
                                <span class="icon-park-outline--hotel" style="font-size: 20px; text-align:center;"></span>EXTENSIÓN PENSIÓN
                            </h4>
                        </div>
                    </div>
                        ...
                        <div class="row d-flex justify-content-center" style="margin-bottom: -11px;">
                            ...
                            <div class="col-md-3">
                                <p style="font-weight: bold">Fecha de salida: <span style="font-weight: normal">
                                        {{-- {{ $reception->exit_date }}  --}}
                                        {{ \Carbon\Carbon::parse($reception->exit_date)->translatedFormat('d-M-Y') }}</span>
                                    </p>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" onsubmit="NewExtension(event)"  role="form" 
                        enctype="multipart/form-data" id="ExtensionService">
                            @csrf

                            @include('hotel.formExtension')
...
@push('scripts')
    ...
    <script src="{{ asset('js/hotels/extension.js') }}" defer></script>
@endpush
