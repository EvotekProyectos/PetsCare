...
<body>
            ...
            <table style="width: 100%;">
                <tr>
                    <th style="text-align: center; width: 20%">
                        <p style="font-size: 15pt; font-weight: bold;font-family:sans-serif;">AUTORIZACIÓN DE
                            PROCEDIMIENTOS
    ...
    <div>
        <p style="text-align:right;  margin-top:10px;">
            <b>Fecha:</b> {{ \Carbon\Carbon::now()->format('d/m/Y H:i') }}
        </p>
    </div>
    ...
    <div style="margin-left: 3%;">
        <p style="width: 100%; text-align: justify; margin-top: 2%; margin-bottom: 1%;">
            <b> Propietario de la mascota que a continuación se describe:
        </p></b>
    ...
    <div>
        <table style="width: 100%; border-collapse: collapse; margin-top:2%;">
            <tr>
                <td>
                    <ol>
                        <li> Por medio de la presente autorizo la realización del procedimiento quirúrgico y/o
                            anestésico:
                            ...
                            que indica el mismo. El presupuesto de dicha intervención es de <b>TOTAL $
                                @if (!isset($isPdf) || !$isPdf)
                                    <input type="text" id="total" name="total" value="{{ $total ?? '' }}"
                                        class="form-control" style="width: 300px;" readonly>
                                @else
                                    <span>{{ $total ?? '' }}</span>
                                @endif
                            </b>
                        ...
                        <li>Si dentro del procedimiento quirúrgico se detecta alguna otra patología, seré notificado
                            oportunamente
                        ...
                        <li>
                            ...
                            que este sea,
                            precisa que mi mascota sea anestesiada, además de que reciba terapia pre-, trans-, y post-
                            operatoria,
                            dependiendo de la idiosincrasia y naturaleza individual del paciente, razón por lo cual
                            acepto los riesgos
                            por la aplicación de los medicamentos. Y que, si por alguna causa este falleciera, no
                            presentaré reclamación
                            posterior de ninguna índole.
                        </li>
                        <li>
                            Por políticas de la empresa el propietario tendrá que realizar un depósito del 50% del costo
                            total (SOLO ELECTIVAS)
                            del procedimiento a realizar para llevarse a cabo, en CIRUGÍAS DE URGENCIA se cubrirá el
                            COSTO TOTAL, el 100%.
                        ...
                        <li>
                            En caso de que el paciente presente alguna complicación y/o tenga que permanecer más tiempo
                            hospitalizado los
                            gastos generados, estudios y hospitalización serán autorizados y pagados por el propietario
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <ol start="8">
                ...
                <li>Los exámenes de laboratorio que indique el medico a cargo, son indispensables
                    para efectuar el procedimiento anestésico y/o quirúrgico, mismos que tendrán un costo extra para el
                    propietario. </li>

                <li>
                    Solo se dará información a una sola persona la cual firma la orden de autorización para evitar
                    problemas de malentendidos.
                    La persona que autoriza deberá ser mayor de edad.
                </li>

                <li>
                    Hacemos de su conocimiento que, si su mascota no es recogida en la fecha indicada por el médico,
                    pasará a nuestro servicio de pensión lo cual
                    implicara el costo extra de la misma, si después de 3 días no pasan a recoger al paciente sin previo
                    aviso se considerara
    ...
    <div style="text-align: center;">
        ...
        @else
            <canvas id="canvas" class="border border-dark p-0" width="200" height="100"
                style="border-bottom: 2px solid #2b2b2b;"></canvas>
        @endif
