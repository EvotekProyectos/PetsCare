...
<div class="row padding-1 p-1">
    <div class="col-md-12">
       ...
       placeholder="Número de ticket">
        ...
        {{-- <div class="form-group mb-2 mb20">
           ...
           <select name="family_id" class="form-control select @error('family_id') is-invalid @enderror"
        ...
        <div class="form-group mb-2 mb20">
            <label for="pet_id" class="form-label">MASCOTA</label>
                    <div class="input-group mb-3">
                        ...
                        <select name="pet_id" class="form-control select @error('pet_id') is-invalid @enderror"
    ...
    <div class="form-group mb-2 mb20">
        ...
        <div class="input-group mb-3">
            ...
            <select name="family_id" class="form-control select @error('family_id') is-invalid @enderror" id="family_id" disabled>
                <option value="{{ $reception->family->id }}">{{ $reception->family->name }}</option>
            </select>
            <input type="hidden" name="family_id" value="{{ $reception->family->id }}">
        </div>
    </div>
    ...
    <div class="form-group mb-2 mb20">
        ...
        <div class="input-group mb-3">
            ...
            <select name="pet_id" class="form-control select @error('pet_id') is-invalid @enderror" id="pet_id" disabled>
                <option value="{{ $reception->pet->id }}">{{ $reception->pet->name }}</option>
            </select>
            <input type="hidden" name="pet_id" value="{{ $reception->pet->id }}">
        </div>
    </div>
