...
<body>
            ...
            @if (!isset($isPdf) || !$isPdf)
                <div style="display: flex; justify-content: center; gap: 20px;">
                    ...
                    <div style="align-self: flex-start;">
                        <button type="button" class="btnLimpiar btn btn-lmx button" data-target="canvas"
    ...
    <script src="{{ asset('js/vouchers/format.js') }}" defer></script>
    <script>
    ...
    <script>
        const GENERATE_VOUCHER_URL = "{{ route('vouchers.generate', $voucher->id) }}";
    </script>
</body>
