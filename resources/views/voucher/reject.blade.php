...
<body>
    ...
    <form id="formVale">
        ...
        <div class="section-title">MOTIVO DE RECHAZO</div>
        <div class="motivo-box">
            @if (!isset($isPdf) || !$isPdf)
                <textarea name="observaciones" rows="4" placeholder="Escriba el motivo de rechazo..." style="width: 100%;"
                    required></textarea>
            @else
    ...
    <script src="{{ asset('js/vouchers/reject.js') }}" defer></script>
    <script>
    ...
    <script>
        const REJECT_VOUCHER_URL = "{{ route('vouchers.reject', $voucher->id) }}";
    </script>
</body>
